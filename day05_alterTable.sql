...
------------------------------------------------------------------------------*/ 
 ...
 --    add ulke_isim2 VARCHAR(20) default 'Turkiye' after sehir;
...
alter table personel
drop column sirket;  -- sütün siler column colon demek
...
------------------------------------------------------------------------------*/  
 alter table personel
 rename column ulke_isim to ülke_adi;
...
alter table issiler
modify ülke_adi varchar(30) not null;
