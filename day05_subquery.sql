...
where isyeri in(select marka_isim from markalar
 ...
 /* ----------------------------------------------------------------------------
  ...
  sayilarini ve marka isim listeleyiniz.
...
==============================================================================*/   
 ...
 -----------------------------------------------------------------------------*/
    ...
    -- patanret dışına bir boşluk yapıp isim vere biliriz yada isimden önce AS yazabiliriz
 ...
 select marka_isim,calisan_sayisi, (select ROUND(avg(maas)) from calisanlar where marka_isim=isyeri) maas_ortalama
   from  markalar;
    
   -- avg ortalama alırelease savepoınt
   -- round rakamları yuvarlar
 ...
 (select round (min(maas)) from calisanlar where marka_isim=isyeri) min_maas 
 from markalar;
