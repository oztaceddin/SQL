...
/* -----------------------------------------------------------------------------
  ORNEK1: Maasi 4000’den cok olan isci isimlerini  'union'5000 liradan fazla maas 
...
select maas,isim as isim_şehir from personel
...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan  personel varsa ismini listeleyin
------------------------------------------------------------------------------*/ 
...
select  sehir as şehit_tel,maas as maas_cocukSayısı from personel
where id=123456789
union
...
/* -----------------------------------------------------------------------------
  ORNEK8: şirketlerden grupla şirketlerin çalışan isimlerini say
------------------------------------------------------------------------------*/

select sirket,count(isim) kisi_sayısı from personel
group by sirket;
